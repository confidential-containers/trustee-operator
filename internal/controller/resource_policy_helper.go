...
// For IBM SE, the IBM SE-specific template is always used regardless of profile.
func generateResourcePolicyRego(isIBMSE bool, profileType string) (string, error) {
