...
# quay.io/confidential-containers/kbs-operator-bundle:$VERSION and quay.io/confidential-containers/kbs-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/confidential-containers/kbs-operator
...
KBS_IMAGE_NAME ?= ghcr.io/confidential-containers/key-broker-service:built-in-as-v0.19.0
