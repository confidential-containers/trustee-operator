...
CURRENT_VERSION=$(get_version_from_makefile) || exit 1
...
log_info ""
log_info "Next steps:"
log_info "  1. Review the changes above"
log_info "  2. Use the automated release workflow:"
log_info "     ${SCRIPT_DIR}/do-release.sh ${NEW_VERSION} --fork YOUR_FORK_URL"
log_info ""
log_info "  Or manually commit and create PR if needed"
